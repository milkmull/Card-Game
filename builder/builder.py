...
from .media.audio_capture import Audio_Capture
...
from ui.element.standard import Image, Textbox, Button, Input, Text_Flipper, Slider
from ui.element.complex import Dropdown
...
class Type_Selector(Dropdown):
    def __init__(self, card, ne):
        ...
        super().__init__(types, selected=card.type, size=(100, 20))
        self.card = card
        self.ne = ne
...
class Builder(Menu):
    ...
    def builder_objects(self):
        ...
        custom = Input(size=(100, 30), message='tag', color=(255, 255, 255), fgcolor=(0, 0, 0), check=Input.alnum_check)
