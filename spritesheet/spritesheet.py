...
class Spritesheet:
    def __init__(self):
        self.spritesheet = spritesheet_base.Base_Sheet(BASE_NAMES, 'data/img/spritesheet.png')
        self.customsheet = spritesheet_base.Base_Sheet(SAVE.get_custom_names(), 'data/img/customsheet.png')
